    ...
    def __call__(self, fn):
        def jsoner(obj, **kwargs):
            ...
            for field in thefields:
                ...
                if key:
                    if hasattr(the_dictionary, "__class__") and hasattr(the_dictionary, "all") and callable(
                            the_dictionary.all) and hasattr(the_dictionary.all(), "json") and recurse < recurse_limit:
            ...
            if hasattr(obj, "_ik") and hasattr(obj, obj._ik.image_field) and hasattr(getattr(obj, obj._ik.image_field),
                                                                                     'size') and getattr(obj,
                                                                                                         obj._ik.image_field):
